...
export class Filter extends React.Component {
    ...
    componentWillMount() {
        ...
        Object.keys(query).map((filters) => (tmp[filters] = query[filters].split(',')));
    ...
    createCheckBoxes = (item, column) => (
        <label key={item}  className="filterContainer">{item}
            <input type="checkbox" value={item} defaultChecked={column.includes(item)} onClick={(e)=>this.handleClicked(column, e)}/>
